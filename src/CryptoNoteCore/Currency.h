...
public:
  ...
  size_t difficultyWindowV4() const { return CryptoNote::parameters::DIFFICULTY_WINDOW_V4; }
...
public:
  ...
  CurrencyBuilder& difficultyWindowV4(uint64_t val) { m_currency.m_difficultyWindowV4 = static_cast<uint32_t>(val); return *this; }
